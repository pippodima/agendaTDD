...
class AgendaSwingAppSQLE2E {
    ...
    private void prepareDatabaseSchema() throws Exception {
        try (Statement stmt = connection.createStatement()) {
            ...
            stmt.executeUpdate("CREATE TABLE todos (" +
    ...
    private void launchApplication() {
        application("dimartinofilippo.agenda.App").withArgs(
                "sql",
                postgres.getJdbcUrl(),
    ...
    void shouldDisplayAllDatabaseElementsOnStart() {
        assertThat(window.list("todoList").contents())
                .anySatisfy(item -> assertThat(item).contains(TODO_1.toString()))
    ...
    void shouldShowErrorWhenAddingExistingTodo() {
        ...
        assertThat(window.list("todoList").contents())
                .containsExactly(TODO_1.toString(), TODO_2.toString());

        window.label("errorMessageLabel")
                .requireText("same ToDo already in the agenda: " + TODO_2.getTitle());
    }
    ...
    void shouldDeleteSelectedTodoSuccessfully() {
        ...
        assertThat(window.list("todoList").contents())
                .containsExactly(TODO_2.toString());
    }
    ...
    void shouldShowErrorWhenDeletingNonExistentTodo() throws Exception {
        ...
        window.label("errorMessageLabel")
                .requireText("ToDo doesn't exist: " + TODO_1.getTitle());
    }
