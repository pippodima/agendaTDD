...
class ToDoSwingViewSQLIT {
	...
	void testAddButtonError() {
		...
		window.label("errorMessageLabel").requireText("same ToDo already in the agenda: Existing Task SQL");
	}
	...
	void testDeleteButtonError() {
		...
		window.label("errorMessageLabel").requireText("ToDo doesn't exist: Non-existent task SQL");
	}
	...
	void testMultipleOperations() {
		...
		String[] listContents = window.list("todoList").contents();
		assertThat(listContents).containsExactlyInAnyOrder(new ToDo("First task", false).toString(),
